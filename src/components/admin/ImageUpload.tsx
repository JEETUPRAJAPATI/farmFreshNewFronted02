...
export default function ImageUpload({
  ...
  const handleFileSelect = async (files: FileList | null) => {
    ...
    try {
      if (multiple && fileArray.length > 1) {
        ...
        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/images/upload/product-images`, {
          method: 'POST',
          body: formData
        });
        ...
        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/images/upload/product-image`, {
          method: 'POST',
          body: formData
        });
  ...
  const removeImage = async (imagePath: string) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/images/delete/product-image`, {
        method: 'DELETE',
        headers: {
